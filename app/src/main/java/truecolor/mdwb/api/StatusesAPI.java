 ...
 */
public class StatusesAPI extends com.weibo.sdk.android.api.WeiboAPI {
	 ...
	 * @param listener
	 */
	public void uploadUrlText( String status, String imageUrl,String id, String lat, String lon,
			RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("status", status);
		params.add("url", imageUrl);
		params.add("pic_id", id);
		if (!TextUtils.isEmpty(lon)) {
			params.add("long", lon);
		}
		if (!TextUtils.isEmpty(lat)) {
	 ...
	 * @param listener
	 */
	public void commentsCreate(String comment, String id, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("comment", comment);
		params.add("id", id);
		request(API_SERVER + "/comments/create.json", params, HTTPMETHOD_POST, listener);
	}
	 ...
	 * @param listener
	 */
	public void commentsReply(String comment, String id, String cid, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("comment", comment);
		params.add("id", id);
		params.add("cid", cid);
		request(API_SERVER + "/comments/reply.json", params, HTTPMETHOD_POST, listener);
	}
	 ...
	 * @param listener
	 */
	public void commentsDestroy( String id, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("cid", id);
		request( API_SERVER + "/comments/destroy.json", params, HTTPMETHOD_POST, listener);
	}

	/**
	 * 添加一条微博到收藏里
	 */
	public void favoritesCreate( String id, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("id", id);
		request( API_SERVER + "/favorites/create.json", params, HTTPMETHOD_POST, listener);
	}

	/**
	 * 取消收藏一条微博
	 */
	public void favoritesDestroy( String id, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("id", id);
		request( API_SERVER + "/favorites/destroy.json", params, HTTPMETHOD_POST, listener);
	}
...
//	 * @param listener
//	 */
//	public void repost(String status, String id, int is_comment, RequestListener listener) {
//		WeiboParameters params = new WeiboParameters();
//		params.add("status", status);
//		params.add("id", id);
