 ...
 *
 */
public class FriendshipsAPI extends com.weibo.sdk.android.api.WeiboAPI {
	 ...
	 * @param listener
	 */
	public void friends(String uid,int cursor, boolean trim_status,
						 RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
//		params.add("count", count);
		params.add("uid", uid);
		if (cursor != 0) params.add("cursor", cursor);
		if (trim_status) {
